...
- **Performance**: See [performance.md](performance.md) for parallel execution patterns
- **Assertions**: See [assertions-waiting.md](assertions-waiting.md) for auto-waiting patterns
- **Global Setup**: See [global-setup.md](global-setup.md) for setup vs fixtures decision
